...
from agent import map, player, safezone, supplies
...
class AgentEntry(Agent):
    ...
    def abandon(self, num: int, targetSupply: str):
        ...
        try:
            ...
            self.Logger.error("Failed to abandon: " + str(e))
    ...
    def pick_up(self, targetSupply: str, num: int, x: float, y: float):
        ...
        try:
            ...
            self.Logger.error("Failed to pick up: " + str(e))
    ...
    def switch_arm(self, targetFirearm: str):
        ...
        try:
            ...
            self.Logger.error("Failed to switch arm: " + str(e))
    ...
    def use_medicine(self, medicineName: str):
        ...
        try:
            ...
            self.Logger.error("Failed to use medicine: " + str(e))
    ...
    def use_grenade(self, x: float, y: float):
        ...
        try:
            ...
            self.Logger.error("Failed to use grenade: " + str(e))
    ...
    def move(self, x: float, y: float):
        ...
        try:
            ...
            self.Logger.error("Failed to move: " + str(e))
    ...
    def stop(self):
        ...
        try:
            ...
            self.Logger.error("Failed to stop: " + str(e))
    ...
    def attack(self, x: float, y: float):
        ...
        try:
            ...
            self.Logger.error("Failed to attack: " + str(e))
    ...
    def choose_origin(self, x: float, y: float):
        ...
        try:
            ...
            self.Logger.error("Failed to choose origin: " + str(e))
