...
class Agent:
    ...
    def _abandon(self, num: int, targetSupply: str):
        ...
        Abandon the supply.
        '''
        self._send(message.PerformAbandonMessage(
            token = self._token,
            numb = num,
    ...
    def _pick_up(self, targetSupply: str, num: int, x: float, y: float):
        ...
        Pick up the supply.
        '''
        self._send(message.PerformPickUpMessage(
            token = self._token,
            targetSupply = targetSupply,
            num = num,
    ...
    def _switch_arm(self, targetFirearm: str):
        ...
        Switch the firearm.
        '''
        self._send(message.PerformSwitchArmMessage(
            token = self._token,
    ...
    def _use_medicine(self, medicineName: str):
        ...
        Use the medicine.
        '''
        self._send(message.PerformUseMedicineMessage(
            token = self._token,
    ...
    def _use_grenade(self, x: float, y: float):
        ...
        Use the grenade.
        '''
        self._send(message.PerformUseGrenadeMessage(
            token = self._token,
            targetPosition = message.Position(
                x = x,
                y = y
    ...
    def _move(self, x: float, y: float):
        ...
        '''
        self._send(message.PerformMoveMessage(
            token = self._token,
            destination = message.Position(
                x = x,
                y = y
            )
        ))
    ...
    def _stop(self):
        ...
        Stop moving.
        '''
        self._send(message.PerformStopMessage(
            token = self._token
        ))
    ...
    def _attack(self, x: float, y: float):
        ...
        Attack the target.
        '''
        self._send(message.PerformAttackMessage(
            token = self._token,
            targetPosition = message.Position(
                x = x,
                y = y
    ...
    def _get_player_info(self):
        ...
        '''
        self._send(message.GetPlayerInfoMessage(
            token = self._token
        ))
    ...
    def _get_map(self):
        ...
        '''
        self._send(message.GetMapMessage(
            token = self._token
        ))
    ...
    def _choose_origin(self, x: float, y: float):
        ...
        Choose the origin.
        '''
        self._send(message.ChooseOriginMessage(
            token = self._token,
            originPosition = message.Position(
                x = x,
                y = y
            )
        ))
